...
const notification_receive_1 = require("./notification-receive");
var EntityType;
(function (EntityType) {
...
__decorate([
    (0, typeorm_1.OneToMany)(() => notification_receive_1.NotificationReceive, (notificationReceive) => notificationReceive.Notification, { cascade: true }),
