...
export class reCreateDB1661151015646 implements MigrationInterface {
    name = 'reCreateDB1661151015646'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`notifications\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`entity_id\` int NULL, \`entity_type\` enum ('friend_ships', 'posts', 'reactions', 'photos', 'comments', 'users', 'profiles', 'privacy') NULL, \`notify_type\` enum ('add friend request', 'accept', 'has react', 'has comment') NULL, \`data\` text NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`privacy\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`user_id\` int NOT NULL, \`view_post\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`comment_post\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`share_post\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`reaction_post\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`view_friendship\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`view_photo\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`view_profile\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', PRIMARY KEY (\`user_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`profiles\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`user_id\` int NOT NULL AUTO_INCREMENT, \`bio\` varchar(255) NOT NULL, \`dob\` varchar(255) NOT NULL, \`phone_number\` varchar(255) NOT NULL, \`come_from\` varchar(255) NOT NULL, \`work_place\` varchar(255) NOT NULL, \`relationship_status\` enum ('single', 'dating', 'married') NULL, \`email\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_5b49bd22c967ce2829ca8f1772\` (\`email\`), PRIMARY KEY (\`user_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`user_status\` enum ('active', 'inactive', 'locked') NULL DEFAULT 'active', \`first_name\` varchar(255) NOT NULL, \`last_name\` varchar(255) NOT NULL, \`given_name\` varchar(255) NOT NULL, \`gender\` enum ('male', 'female', 'other') NULL, \`avatar_url\` varchar(255) NOT NULL DEFAULT 'https://as2.ftcdn.net/jpg/02/15/84/43/220_F_215844325_ttX9YiIIyeaR7Ne6EaLLjMAmy4GvPC69.jpg', \`cover_photo_url\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`profileUserId\` int NULL, \`privacyUserId\` int NULL, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`REL_7da77968af7f79a98e4b28bb9d\` (\`profileUserId\`), UNIQUE INDEX \`REL_505172424dcd411ba576478d4e\` (\`privacyUserId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`photos\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`post_id\` int NOT NULL, \`owner_id\` int NOT NULL, \`photo_type\` enum ('profile', 'avatar', 'cover', 'post') NULL, \`photo_url\` varchar(255) NOT NULL, \`count_reaction\` int NOT NULL DEFAULT '0', \`count_comment\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`reactions\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`entity_id\` int NOT NULL, \`owner_id\` int NOT NULL, \`entity_type\` enum ('friend_ships', 'posts', 'reactions', 'photos', 'comments', 'users', 'profiles', 'privacy') NOT NULL, \`reaction_type\` enum ('like', 'love', 'haha', 'sad', 'angry') NULL DEFAULT 'like', PRIMARY KEY (\`entity_id\`, \`owner_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`posts\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`owner_id\` int NOT NULL, \`privacy_mode\` enum ('public', 'friend', 'private', 'all') NULL DEFAULT 'public', \`text\` varchar(255) NOT NULL, \`count_reaction\` int NOT NULL DEFAULT '0', \`count_comment\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comments\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`entity_id\` int NOT NULL, \`owner_id\` int NOT NULL, \`entity_type\` enum ('friend_ships', 'posts', 'reactions', 'photos', 'comments', 'users', 'profiles', 'privacy') NOT NULL, \`text\` varchar(255) NOT NULL, \`count_reaction\` int NOT NULL DEFAULT '0', \`count_comment\` int NOT NULL DEFAULT '0', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`friend_ships\` (\`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`id\` int NOT NULL AUTO_INCREMENT, \`sender_uid\` int NOT NULL, \`receiver_uid\` int NOT NULL, \`friendship_status\` enum ('pending', 'beFriended', 'blocked', 'rejectFriend') NULL DEFAULT 'pending', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
